...
CREATE TABLE `devices` (
    ...
    `token_notification` VARCHAR(255) NULL,
    `cat` BOOLEAN NULL,
    `dog` BOOLEAN NULL,
    `created_at` TIMESTAMP(0) NULL,
    `updated_at` TIMESTAMP(0) NULL,
...
CREATE TABLE `indicacoes` (
    ...
    `estoque` BOOLEAN NULL DEFAULT false,
...
CREATE TABLE `meta_regioes` (
    ...
    `meta_estado_id` INTEGER NOT NULL,
    `campo` VARCHAR(45) NOT NULL,
    `descricao` VARCHAR(85) NOT NULL,
    `valor` VARCHAR(65) NOT NULL,
...
-- CreateTable
CREATE TABLE `meta_subregioesbkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `created` DATETIME(0) NOT NULL,
    `status` INTEGER NOT NULL DEFAULT 1,
    `regiao_id` INTEGER NOT NULL,
