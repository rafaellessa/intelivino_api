...
CREATE TABLE `campaigns` (
    ...
    `on_confirmation_end` VARCHAR(500) NULL,
    `coupon` VARCHAR(30) NULL,
    `ask_for_address` TINYINT NULL DEFAULT 0,
    `ask_for_catalog` TINYINT NULL DEFAULT 0,
...
CREATE TABLE `coupon` (
    ...
    UNIQUE INDEX `coupon_user_id_code_key`(`user_id`, `code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `lead` (
    ...
    `converted` TINYINT NOT NULL DEFAULT 1,
...
-- CreateTable
CREATE TABLE `lead_converted_by_campaign` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `lead_id` INTEGER NOT NULL,
    `campaign_id` INTEGER UNSIGNED NULL,
    `created_at` TIMESTAMP(0) NULL,
    ...
    INDEX `lead_converted_campaign`(`campaign_id`),
    INDEX `lead_converted_lead`(`lead_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `notification_v2` (
    ...
    INDEX `notification_v2_order_id_fkey`(`order_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `pedidos` (
    ...
    INDEX `pedidos_coupon_id_fkey`(`coupon_id`),
...
-- AddForeignKey
ALTER TABLE `lead_converted_by_campaign` ADD CONSTRAINT `lead_converted_campaign` FOREIGN KEY (`campaign_id`) REFERENCES `campaigns`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `lead_converted_by_campaign` ADD CONSTRAINT `lead_converted_lead` FOREIGN KEY (`lead_id`) REFERENCES `lead`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `notification_v2` ADD CONSTRAINT `notification_v2_order_id_fkey` FOREIGN KEY (`order_id`) REFERENCES `pedidos`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
